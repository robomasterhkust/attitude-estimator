...
%These are Z-Y-X coordinates
%{phi=atan2(Rot_matrix(2,3),Rot_matrix(3,3));
%theta=-asin(Rot_matrix(1,3));
%psi=atan2(Rot_matrix(1,2),Rot_matrix(1,1));
%These are Z-X-Y coordinates

phi=asin(Rot_matrix(3,2));
theta=-atan2(Rot_matrix(3,1),Rot_matrix(3,3));
psi=-atan2(Rot_matrix(1,2),Rot_matrix(2,2));
